...
const styles = StyleSheet.create({
  ...
  previewImage: { width: 240, height: 160, borderRadius: Radius.lg, backgroundColor: Colors.glass, resizeMode: 'contain' },
  ...
  posterThumb: { width: 120, height: 180, borderRadius: Radius.md, backgroundColor: Colors.glass },
  reviewHeaderInfo: { flex: 1, justifyContent: 'center' },
  ticketThumbReview: { width: '100%', height: 140, borderRadius: Radius.md, backgroundColor: Colors.glass, resizeMode: 'contain' },

  warningBanner: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, backgroundColor: Colors.glass, padding: Spacing.md, borderRadius: Radius.md, marginBottom: Spacing.md, borderWidth: 0.5, borderColor: Colors.amber },
  ...
  fieldInput: { fontFamily: Typography.mono, fontSize: 15, color: Colors.cream, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: Radius.md, paddingHorizontal: Spacing.md, paddingVertical: Spacing.md, borderWidth: 0.5, borderColor: Colors.glassBorder },
  ...
  // Terminal
  terminal: { marginTop: Spacing.lg, borderRadius: Radius.md, overflow: 'hidden', borderWidth: 0.5, borderColor: Colors.glassBorderLight, width: '100%' },
  terminalHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: Colors.glass, paddingHorizontal: Spacing.md, paddingVertical: 8, borderBottomWidth: 0.5, borderBottomColor: Colors.glassBorder },
